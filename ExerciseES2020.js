...
console.log(Number.MAX_SAFE_INTEGER)  // Answer = 9007199254740991
console.log(Number.MIN_SAFE_INTEGER)  // Answer = -9007199254740991

// Exercise 2: why does this throw an error? How can you fix it?
3 + 4 + 1n  // errors because different data types.
// Fix is - 3n+4n+1n  output = 8n
...
// SOLUTION
if (andrei_pokemon?.raichu && will_pokemon?.pikachu?.
    friend?.charizard) {
        console.log('fight!');
    } else {
        console.log('walk away')
